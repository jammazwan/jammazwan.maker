...
Functionality: **_Uses JPA and biny to seed a database from many different csv files_**
...
so you can focus only on what is required to demo the **SeedDbFromManyCsvFiles** feature **_in isolation_**.
...
_No Special Instructions yet_

### other notes

The prefix **xab** is used for maintaining sort order in a directory, providing packaging, and is otherwise meaningless. The x stands for _example_.
